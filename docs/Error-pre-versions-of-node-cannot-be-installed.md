...
To avoid this error completely just use a stable release of node.js. i.e. `v0.10.4`, and **not** `v0.10.4-pre`.
...
**Note:** This is for advanced users who use `-pre` versions of node more often than tagged releases.
